  ...
  return (
    ...
    >
      ...
      {ciLow !== undefined && ciHigh !== undefined && (() => {
        ...
        return (
          <>
            {/* Whisker line — light grey for legibility against zone fills */}
            <div
              className="absolute top-1/2 -translate-y-1/2 h-px bg-muted-foreground pointer-events-none"
            ...
            {!lowOpen && (
              <div
                className="absolute top-1/3 bottom-1/3 w-px bg-muted-foreground pointer-events-none"
                style={{ left: `${ciLowPct}%` }}
