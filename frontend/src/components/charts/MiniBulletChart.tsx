      ...
      {ciLow !== undefined && ciHigh !== undefined && (() => {
        ...
        return (
          <>
            ...
            <div
              className="absolute top-1/2 -translate-y-1/2 h-px bg-zinc-500 pointer-events-none"
            ...
            {!lowOpen && (
              <div
                className="absolute top-1/3 bottom-1/3 w-px bg-zinc-500 pointer-events-none"
                style={{ left: `${ciLowPct}%` }}
