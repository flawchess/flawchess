...
export function MoveList({ moveHistory, currentPly, onMoveClick }: MoveListProps) {
  ...
  if (moveHistory.length === 0) {
    return (
      <div className="h-12 sm:h-18 overflow-y-auto rounded border border-border bg-muted/30 p-2 text-sm text-muted-foreground">
        No moves yet
      </div>
    );
  }
  ...
  return (
    <div className="h-12 sm:h-18 overflow-y-auto rounded border border-border bg-muted/30 p-2 text-sm">
