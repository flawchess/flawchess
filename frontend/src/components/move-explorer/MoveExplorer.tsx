                ...
                <span className="inline-flex items-center gap-1">
                  ...
                  <InfoPopover ariaLabel="Move arrows info" testId="move-arrows-info" side="top">
                    <div className="space-y-2">
                      <p>
                        These are the moves that occurred next in the position shown on the board, over all the games that match the current filter settings. Moves with fewer than {MIN_GAMES_FOR_RELIABLE_STATS} games are dimmed.
                      </p>
                      <p>
