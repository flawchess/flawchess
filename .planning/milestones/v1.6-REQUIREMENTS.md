# Requirements Archive: v1.6 UI Polish & Improvements
...
- [x] **ORT-03**: Endpoint returns top 10 openings per color with WDL stats computed in SQL, filtered by recency/time_control/platform/rated/opponent_type, excluding openings below ply threshold
...
| MOB-02 | Phase 39 | Complete |
| MOB-03 | Phase 39 | Complete |
| MOB-04 | Phase 39 | Complete |
| MOB-05 | Phase 39 | Complete |
| MOB-06 | Phase 39 | Complete |
| MOB-07 | Phase 39 | Complete |
