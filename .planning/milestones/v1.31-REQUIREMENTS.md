# Requirements: FlawChess — v1.31 Pipeline Consolidation

> **ARCHIVED** — Milestone v1.31 completed 2026-07-04 (Phases 148, 149, 150; tag v1.31; merged to `main`, prod deploy pending).
> All 18 v1.31 requirements complete. See `.planning/milestones/v1.31-ROADMAP.md` for the full phase record.
