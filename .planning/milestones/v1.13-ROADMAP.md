...
All v1.13 active requirements (16 total) are mapped to exactly one phase. Pre-v1.13 quick tasks PRE-01 and PRE-02 are intentionally **not** mapped — they are pre-roadmap quick tasks gating Phase 70's start.
