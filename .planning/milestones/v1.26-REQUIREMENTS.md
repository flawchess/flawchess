# Requirements Archive — v1.26 Full-Game Eval Pipeline

> **ARCHIVED 2026-06-14.** Snapshot of `.planning/REQUIREMENTS.md` at v1.26 close.
> All 22 in-scope requirements complete (EVAL-01..06, QUEUE-01..08, EVUX-01..03, EVALFIX-01..05).
> This document covers Phases 116–118 + 117.1 + 117.2 (the EVAL / QUEUE / EVUX / EVALFIX families).
> Phase 119 (eval-drain coverage) and Phase 120 (headless remote eval worker) were seed-driven
> additions tracked via SEED-045 / SEED-046 and SEED-048 (locked decisions D-1..D-7) respectively,
> not the original requirements doc. See `v1.26-ROADMAP.md` for their goals and plans.
