...
- 🚧 **v1.32 Maia-3 Human-Move Enrichment** — Phases 151, 151.1 (in progress; started 2026-07-04; Phase 152 demoted to SEED-084) — browser-only client-side Maia-3, zero DB writes; relicense MIT → AGPL-3.0 (SEED-081)
...
| 152. Flaw Overlay (Pillars A + B) | 0/0 | Demoted → SEED-084 | - |
...
*Phase 152 (Flaw Overlay, Pillars A + B) was demoted to [SEED-084](seeds/SEED-084-flaw-overlay-pillars-a-b.md) at the v1.32 close — not needed for this milestone; FLAW-01..04 captured in the seed for a future Maia-enrichment milestone.*
