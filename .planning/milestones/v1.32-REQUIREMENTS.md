# Requirements Archive: v1.32 Maia-3 Human-Move Enrichment
...
### Flaw Overlay (FLAW) — DEFERRED → SEED-084

*Phase 152 (Flaw Overlay, Pillars A + B) was demoted to [SEED-084](seeds/SEED-084-flaw-overlay-pillars-a-b.md) at the v1.32 close — not needed for this milestone. FLAW-01..04 below are captured verbatim in the seed for a future Maia-enrichment milestone.*
...
| FLAW-01 | SEED-084 | Deferred (Phase 152 demoted) |
| FLAW-02 | SEED-084 | Deferred (Phase 152 demoted) |
| FLAW-03 | SEED-084 | Deferred (Phase 152 demoted) |
| FLAW-04 | SEED-084 | Deferred (Phase 152 demoted) |

**Coverage:**

- v1 requirements: 18 total (14 delivered in v1.32; FLAW-01..04 deferred → SEED-084)
- Mapped to phases: 14 (FLAW-01..04 demoted to SEED-084 at v1.32 close)
- Unmapped: 0 ✓
