...
| 76-03-01 | 03 (frontend arrow/color) | 1 | INSIGHT-UI-01, INSIGHT-UI-02 (D-12/D-13/D-15) | — | Score-based bucket boundaries match backend constants | unit | `cd frontend && npx vitest run src/lib/__tests__/arrowColor.test.ts` | ❌ W0 | ⬜ pending |
| 76-03-02 | 03 (frontend openingInsights.ts) | 1 | INSIGHT-UI-06 (D-17/D-20) | — | Stale constants removed, popover copy constant added | unit + knip | `cd frontend && npx vitest run src/lib/__tests__/openingInsights.test.ts && npm run knip` | ✅ | ⬜ pending |
| 76-04-01 | 04 (frontend types) | 3 | INSIGHT-UI-05 (D-21), INSIGHT-UI-03 | — | Type catch-up — kills "NaN%" runtime bug | type-check | `cd frontend && npx tsc --noEmit` | ✅ | ⬜ pending |
