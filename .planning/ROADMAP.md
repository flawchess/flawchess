...
- 🚧 **v1.17 Endgame Stats Card Redesign** — Phases 84-88, 85.1 (opened 2026-05-12) — see [milestones/v1.17-ROADMAP.md](milestones/v1.17-ROADMAP.md)
...
- [ ] Phase 85.1: Hypothesis tests + CIs for Endgame Score Differences (4 plans, INSERTED 2026-05-14) — planned
...
| 84-88, 85.1. v1.17 phases | v1.17 | 0/TBD | In progress | — |
