...
**Plans**: 6 plans
  - [ ] 71-01-PLAN.md — Phase 70 contract amendment: add entry_san_sequence to OpeningInsightFinding
  - [ ] 71-02-PLAN.md — Extract LazyMiniBoard from GameCard into shared module
  - [ ] 71-03-PLAN.md — Types, openingInsights helpers (trim, severity-color, threshold copy), useOpeningInsights hook
  - [ ] 71-04-PLAN.md — OpeningFindingCard component (per-finding card with severity border, dual layout, prose)
  - [ ] 71-05-PLAN.md — OpeningInsightsBlock component (outer block, 4 sections, loading/error/empty/populated states)
...
| 71. `OpeningInsightsBlock` (Stats subtab) | v1.13 | 0/6 | Planned | — |
