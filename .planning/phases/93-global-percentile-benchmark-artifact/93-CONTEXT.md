...
- **D-06: Tail-densified breakpoint set is locked** at `p0.1, p0.5, p1, p2.5, p5, p10, p20, p30, p40, p50, p60, p70, p80, p90, p95, p97.5, p99, p99.5, p99.9` (19 breakpoints). Honest "top 0.1% / bottom 0.1%" annotations at the extremes; uniform p0..p100 would compress the tails users care most about.
