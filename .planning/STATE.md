...
Last activity: 2026-07-02 - Completed quick task 260702-nm8: Analysis board shows flaw tags (severity row + 3-column Missed/Allowed/Context) below the eval chart + new mobile Tags tab, click-to-cycle synced with board/move list/eval chart
