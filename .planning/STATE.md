...
---
Last activity: 2026-05-04 — Completed quick task 260504-rvh: removed eval color-baseline centering. MG-entry bullet chart axis now centered on 0 cp; zone bounds redefined symmetrically around 0 (±0.30 pawns); per-color baseline survives as a small tick mark on the chart and as the null hypothesis for backend stats now drops to 0 cp.
