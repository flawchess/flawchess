...
---
Last activity: 2026-05-06 — Completed quick task 260506-rtk: Openings → Stats subtab now uses the two-column card grid from the Insights tab (white left, black right) with permanent miniboards, WDL chart rows replacing "You score…" copy, and the existing eval bullet chart carried over as the card's bullet. MostPlayedOpeningsTable + MinimapPopover removed.
