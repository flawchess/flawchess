...
status: resolved
resolved: 2026-06-03
resolved_by: quick task 260603-o8m (commits adc0864f migration, 694f361a ORM+backfill, 9eae456c reindex script, ed5cf4c6 test). Code shipped to main; prod-scale CONCURRENTLY timing + the actual prod run of scripts/reindex_table.py remain DEPLOY/HUMAN-UAT.
planted: 2026-06-01
