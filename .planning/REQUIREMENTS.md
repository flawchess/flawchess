...
Requirements for v1.4 Improvements milestone.
...
| Feature | Reason |
|---------|--------|
| Google Analytics | Requires cookie consent, GDPR complexity |
| User-level behavioral tracking | Privacy violation, not needed for site-level analytics |
