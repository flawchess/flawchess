...
v1.15 Eval-Based Endgame Classification shipped 2026-05-03 (PR #78 combined Phase 78 + 79; PR #79 follow-on `EnginePool` parallelisation). Fifteen milestones complete (v1.0–v1.15), 75 phases (+4 inserted), live at flawchess.com.
...
---
*Last updated: 2026-05-03 — v1.15 Eval-Based Endgame Classification shipped (PRs #78, #79). Hard cutover for endgame conv/recov classification; per-position `phase` SmallInteger column populated; middlegame-entry Stockfish eval substrate in place. v1.16 Stockfish Eval Analyses opens — first phase: opening-stats columns for middlegame-entry eval and clock diff. SEED-010 Library milestone now eligible to open.*
