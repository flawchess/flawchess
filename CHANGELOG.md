...
- Library eval chart: games ending in checkmate now show the final ply (a flat 100% / 0% bar) instead of dropping it, since the mated position has no engine eval. Flaw dots at the very top or bottom of the chart no longer get clipped, and the white-ahead / black-ahead fills now read as lighter grey vs dark grey.
